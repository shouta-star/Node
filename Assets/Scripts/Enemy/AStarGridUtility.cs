...
/// <summary>
/// Grid utilities + A* (4-neighborhood).
/// IMPORTANT: uses gridOrigin (same as CellFromStart) so Enemy and Player share the same cell mapping.
/// </summary>
public static class AStarGridUtility
{
    ...
    /// <summary>
    /// Returns path including start and goal, or null if not found.
    /// </summary>
